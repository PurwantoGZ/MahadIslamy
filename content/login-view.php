  ...
  <div class="row">
    <div class="col-lg-6 col-lg-offset-3">
            <div class="form-wrapper">
                  <form  action="login-cek.php" class="form-signin wow fadeInUp" method="POST">
                  <h2 class="form-signin-heading">Login sirkulasi</h2>
                  <div class="login-wrap">
                    <div class="form-group text-center" id="error-teks"></div>
                    <div class="form-group ">
                      <input name="inpuser" autofocus type="text" class="form-control" placeholder="Username" autofocus>
                    </div>
                    <div class="form-group ">
